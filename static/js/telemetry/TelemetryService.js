const ALLOWED_EVENT_NAMES = new Set([
    ...
    'gameplay:tutorial:route_viewed',
    'gameplay:tutorial:started',
    'gameplay:tutorial:failed',
    'gameplay:tutorial:first_input',
    ...
    'gameplay:vehicle:flip_recovered',
    ...
    'error:server:crash',
    'gameplay:player:report_requested',
    'gameplay:player:reset_requested',
